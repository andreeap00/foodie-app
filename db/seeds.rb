...
product2.image.attach(io: File.open(Rails.root.join('seed-images/soup_chicken.png')), filename: 'soup_chicken.png')

product3 = Product.create(title: 'Vitamin Salad', description: 'Salads', price: 20.49, category: 2, vegetarian: 1)
product3.image.attach(io: File.open(Rails.root.join('seed-images/salad_vitamin.png')), filename: 'salad_vitamin.png')

product4 = Product.create(title: 'Pasta with Walnut', description: 'Second Courses', price: 20.99, category: 1, vegetarian: 1)
product4.image.attach(io: File.open(Rails.root.join('seed-images/pasta_walnut.png')), filename: 'pasta_walnut.png')

product5 = Product.create(title: 'Pizza Capriciosa', description: 'Second Courses', price: 35.99, category: 3, vegetarian: 0)
product5.image.attach(io: File.open(Rails.root.join('seed-images/pizza_capriciosa.png')), filename: 'pizza_capriciosa.png')

product6 = Product.create(title: 'Pancake with Fruit', description: 'Desserts', price: 14.49, category: 4, vegetarian: 0)
product6.image.attach(io: File.open(Rails.root.join('seed-images/pancake.png')), filename: 'pancake.png')

product7 = Product.create(title: 'Caesar Salad', description: 'Salads', price: 22.99, category: 2, vegetarian: 0)
product7.image.attach(io: File.open(Rails.root.join('seed-images/salad_caesar.png')), filename: 'salad_caesar.png')
